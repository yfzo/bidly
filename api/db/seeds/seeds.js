exports.seed = function(knex, Promise) {
  ...
  .then(function () {
    ...
    knex('auctions').insert({category_id: 1, name: 'snickers ice cream', description: 'lots of chocolate and tasty', min_bid: '100', end_time: Date.now() + 500000, image: 'https://i.imgur.com/EZjcSmV.jpg', user_id: 1}),
    knex('auctions').insert({category_id: 1, name: 'oreo ice cream', description: 'creamy and tasty', min_bid: '300', end_time: Date.now() + 100000, image: 'https://i.imgur.com/vDhRudd.jpg', user_id: 2}),
