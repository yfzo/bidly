exports.seed = function(knex, Promise) {
  ...
  .then(function () {
    ...
    knex('auctions').insert({category_id: 1, name: 'snickers ice cream', description: 'lots of chocolate and tasty', min_bid: '100', end_time: 1564104273004, image: 'https://i.imgur.com/EZjcSmV.jpg', user_id: 1}),
