exports.seed = function(knex, Promise) {
  ...
  .then(function () {
    ...
    knex('auctions').insert({id: 7, category_id: 2, name: 'Switch Zelda Breathe Of the Wild', description: 'Nintendo Switch Zelda game. With case', min_bid: '6', end_time: Date.now() + 180000, image: 'https://i.ebayimg.com/00/s/MTYwMFgxMjAx/z/GOQAAOSw0VZdQN1X/$_59.JPG', user_id: 2}),
